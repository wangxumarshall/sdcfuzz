...
# and Ubuntu.
DEBIAN_FRONTEND=noninteractive apt install --no-install-recommends -y git bazel bazel-8.6.0 libssl-dev libzstd-dev clang libclang-rt-dev lld python3 libpython3-stdlib
