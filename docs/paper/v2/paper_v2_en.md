...
**Methodological point.** Had we stopped at E8v1 — 45 injections per arm, no length control — the monotone ordering would have entered the literature as "directional support for H2." The length-matched control killed it in one afternoon of automated injections. Making the experiment that refutes your own preliminary signal cheap to run is one of the framework's design goals.
