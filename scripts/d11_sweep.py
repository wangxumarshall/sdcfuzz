...
WL=os.path.expanduser("~/gem5-fi/smoke_test/sdc_probe/sdc_probe_workload_d11")
GOLDEN="SUM=14383279793724115927 CRC=01205202"
NC=70268; ROI_LO=int(NC*0.2); ROI_HI=int(NC*0.8)
def sweep(mode, n_runs, seed, structural=False):
    rng=random.Random(seed)
    rd=os.path.expanduser(f"~/gem5-fi/smoke_test/d11_{mode}_runs")
    ...
    tot=c+e+m+n
    print(f"D11 {mode}: total={tot} clean={c} ({100*c/tot:.1f}%) exit={e} masked={m}")
